...
function [reset_map, sys] = dog_jump_onlyReach_transition_q21(grid, sys)
...
sys.params.state_fcn_arr_q21 = state_fcn_arr;%%<----------------dont forget to rename
